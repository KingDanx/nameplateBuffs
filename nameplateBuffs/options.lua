...
local GetSpellInfo, GetSpellTexture, tonumber, pairs, table_sort, table_insert = C_Spell.GetSpellInfo,
    C_Spell.GetSpellTexture, tonumber, pairs, table.sort, table.insert
        ...
        displayConditions = {
            ...
            args = {
                showDebuffs = {
                    ...
                    style = "dropdown",
                    name = L["Show debuffs"],
                    values = {L["All"], L["Mine + SpellList"], L["Only SpellList"], L["Only mine"], L["None"]}
                },
                showBuffs = {
                    order = 2,
                    type = "select",
        ...
        styleSettings = {
            ...
            args = {
                ...
                durationPosition = {
                    ...
                    values = {L["Under Icon"], L["On Icon"], L["Above Icon"]},
                    disabled = function()
                        return not db.showDuration
                    end
                },
                ...
                stackPosition = {
                    ...
                    values = {L["On Icon"], L["Under Icon"], L["Above Icon"]}
                },
                stackFont = {
                    order = 17,
                    type = "select",
                ...
                borderStyle = {
                    ...
                    style = "dropdown",
                    name = L["Border Style"],
                    values = {L["Square"], "Blizzard", L["None"]}
                },
                colorizeBorder = {
                    order = 25,
                    type = "toggle",
        ...
        CVarSettings = {
            ...
            args = {
                ...
                nameplateInset = {
                    ...
                    width = "full",
                    get = function(info)
                        return db.nameplateInset or
                                   ((GetCVar("nameplateOtherTopInset") == "-1") and
                                       (GetCVar("nameplateOtherBottomInset") == "-1"))
                    end,
                    set = function(info, value)
                        if value then
...
function fPB.BuildSpellList()
    ...
    for i = 1, #spellList do
        ...
        local SpellID = Spell.spellID or s
        ...
        local iconID, originalIconID = GetSpellTexture(s)
        iconTexture = iconID
        ...
        spellTable[tostring(s)] = {
            ...
            args = {
                show = {
                    ...
                    type = "select",
                    style = "dropdown",
                    values = {L["Always"], L["Only mine"], L["Never"], L["On ally only"], L["On enemy only"]}
                },
                scale = {
                    order = 2,
                    name = L["Icon scale"],
                            ...
                            if spellID then
                                ...
                                if spellName then
                                    ...
                                    elseif spellID ~= Spell.spellID and spellName ~= Spell.name then
                                        DEFAULT_CHAT_FRAME:AddMessage(spellID .. chatColor ..
                                                                          L[" It is ID of completely different spell "] ..
                                                                          linkColor .. "|Hspell:" .. spellID .. "|h[" ..
                                                                          GetSpellInfo(spellID) .. "]|h" .. chatColor ..
